...
<div class="portfolio-home">
  <section class="portfolio-hero" aria-labelledby="hero-title">
    <div class="hero-copy">
      <p class="hero-kicker">Mohammed Saidul Islam</p>
      <h1 id="hero-title">Applied ML specialist building production-oriented systems for AI agents, multimodal models, and foundation-model evaluation.</h1>
      <p class="hero-role">Associate Applied Machine Learning Specialist at the Vector Institute.</p>
      <p class="hero-lede">I build end-to-end AI systems spanning agentic benchmark generation, multimodal data pipelines, post-training, automated evaluation, and efficient GPU inference.</p>
      ...
      <ul class="hero-proof" aria-label="Selected evidence">
        <li>Vector Institute</li>
        <li>18M image-text pairs</li>
        <li>70-85% lower latency</li>
        <li>ACL · EMNLP · EACL</li>
      </ul>
    </div>
  ...
  <section class="portfolio-section selected-work-section" aria-labelledby="featured-heading">
    <div class="section-heading">
      <div>
        ...
        <h2 id="featured-heading">Systems with research depth and engineering evidence.</h2>
      </div>
      <p>Applied ML systems spanning agent evaluation, multimodal data, post-training, and visualization intelligence.</p>
    </div>
  ...
  <section class="portfolio-section home-publications-section" aria-labelledby="publications-heading">
    <div class="section-heading">
      ...
      <p>Recent work on agentic systems, multimodal evaluation, data storytelling, and reliable generation.</p>
    </div>
  ...
  <section class="portfolio-section updates-section" aria-labelledby="updates-heading">
    <div class="section-heading">
      ...
      <p>Three recent publications and career milestones.</p>
    </div>
  ...
  <section class="portfolio-section contact-section" aria-labelledby="contact-heading">
    <div class="contact-panel">
      <div><p class="section-marker">Contact</p><h2 id="contact-heading">Interested in applied AI engineering, model evaluation, agents, and multimodal systems?</h2></div>
